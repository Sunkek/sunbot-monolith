...
class Embedder(commands.Cog):
    ...
    @commands.command(
        ...
        help='Creates an embed in selected or current channel. Separate the title and description by `<|>` (yes, brackets included). To add and format the embed use `sb editembed`.',
    )
    async def new_embed(
        self, ctx, 
    ...
    @commands.group(
        name="editembed", 
        brief="Edit an embed",
        help="This is a command group that lets you edit a bot's embed", 
        aliases=['ee'], 
    ...
    @edit_embed.command(
        name="title", 
        aliases=['t'],
        help="Edits selected embed's title", 
    )
    ...
    @edit_embed.command(
        help="Edits selected embed's description", 
        name="description", 
        aliases=['d']
    )
    ...
    @edit_embed.command(
        help="Edits selected embed's color. Provide a hex code.", 
        name="color", 
        aliases=['c']
    )
    ...
    @edit_embed.command(
        help="Edits selected embed's image. Provide an image URL or attachment. Don't delete the latter if you want it to work properly.", 
        name="image", 
        aliases=['i', 'img']
    )
    ...
    @edit_embed.command(
        help="Edits selected embed's thumbnail image. Provide an image URL or attachment. Don't delete the latter if you want it to work properly.", 
        name="thumbnail", 
        aliases=['tn', 'thumb']
    )
    ...
    @edit_embed.command(
        help="Deletes the field at specified index from the selected embed", 
        name="removefield", 
    ...
    @edit_embed.command(
        help="Sets URL for the selected embed", 
        name="url",
    )
    ...
    @edit_embed.command(
        help="Sets footer text for the selected embed. Send no text to reset it", 
        name="footertext",
        aliases=['ft']
    )
    ...
    @edit_embed.command(
        help="Sets footer icon using the image from your URL for the selected embed. Send no URL to reset it", 
        name="footericon",
        aliases=['fi']
    )
    ...
    @edit_embed.command(
        help="Sets author name for the selected embed. Send no text to reset it", 
        name="authorname",
        aliases=['an']
    )
    ...
    @edit_embed.command(
        help="Sets author URL for the selected embed. Send no URL to reset it", 
        name="authorurl",
        aliases=['aurl', 'al', 'au']
    )
    ...
    @edit_embed.command(
        help="Sets author icon to the image by your URL for the selected embed. Send no URL to reset it", 
        name="authoricon",
        aliases=['ai']
    )
